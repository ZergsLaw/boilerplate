...
type RecoveryPasswordBody struct {
	...
	// recovery code
	RecoveryCode models.RecoveryCode `json:"recoveryCode,omitempty"`
}
...
func (o *RecoveryPasswordBody) validateEmail(formats strfmt.Registry) error {
...
func (o *RecoveryPasswordBody) validateRecoveryCode(formats strfmt.Registry) error {
	...
	if swag.IsZero(o.RecoveryCode) { // not required
		return nil
	}
