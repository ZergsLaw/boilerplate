...
// CreateRecoveryCodeParams contains all the bound params for the create recovery code operation
...
func (o *CreateRecoveryCodeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body CreateRecoveryCodeBody
