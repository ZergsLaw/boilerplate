...
//go:generated mockgen -source=../app/notification.go -destination=mock.notification.contracts.go -package mock
//go:generated mockgen -source=../app/wal.go -destination=mock.wal.contracts.go -package mock
